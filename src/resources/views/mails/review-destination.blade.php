...
<div class="order-container">
    <div class="order-field"><span class="font-weight-bold">Order ID:</span> {{$data->payment_intent_id ?? ''}}</div>
    ...
    <div class="order-field"><span class="font-weight-bold">Star:</span> {{$data->star ?? ''}}</div>
    <div class="order-field"><span class="font-weight-bold">Review:</span> {{$data->review ?? ''}}</div>
</div>
</body>
