<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('user-management.queue.index') }}
    @endsection
            ...
            <div class="table-responsive mt-2">
                <table id="queue_table"
                    ...
                    @foreach ($result as $key => $record)
                        <tr class="row-item">
                            <td data-bs-toggle="tooltip" data-bs-placement="left" title="Click to copy to clipboard" class="payment_id text-nowrap cursor-pointer" onclick="copyToClipboard(this)">Tiger Nixon</td>
                            ...
                            <td class="date text-nowrap">{{$key %2 ==0 ? '21/05/2024' : '22/05/2024'}}</td>
